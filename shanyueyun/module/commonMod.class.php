...
class commonMod
{
    ...
    protected function check_login() {
        ...
        if($_GET['_module']=='login'||substr($_GET['_action'],-6)=='ignore'||$_GET['_action']=='person'||$_GET['_action']=='signup'||$_GET['_action']=='batch'||$_GET['_action']=='examine'||$_GET['_action']=='edit'||$_GET['_action']=='edit_save'||$_GET['_action']=='del'){
            return true;
        }
        if(!empty($_GET['key'])){
    ...
    public function load_js() {
        $js='';
        $js .= '<script type=text/javascript src="' . __PUBLICURL__ . '/js/jqueryold.js"></script>' . PHP_EOL;
