        ...
        $html.="
                '#".$id."',
                  
                        {
							...
							items:['source', '|', 'fullscreen','print', 'cut', 'copy', 'paste',
...
'flash', 'media', 'advtable', 'hr', 'emoticons', 'link', 'unlink', '|', 'about'],
    ...
    public function _get_image_upload($button,$id,$ajax=false,$editor='') {
        $html="<script>
        $(document).ready(function() {
            $('#".$button."').click(function(){
                urldialog({
                    title:'图片上传',
                    url:'".__APP__."/editor/_image_upload?id=".$id."&editor=".$editor."',
                    width:620,
                    height:240
                });
            });
    ...
    public function get_image_upload($button,$id,$ajax=false,$editor='') {
        ...
        public function get_logo_upload($button,$id,$ajax=false,$editor='') {
        $html="<script>
        $(document).ready(function() {
            $('#".$button."').click(function(){
                urldialog({
                    title:'图片上传',
                    url:'".__APP__."/editor/logo_upload?id=".$id."&editor=".$editor."',
                    width:620,
                    height:240
                });
            });
