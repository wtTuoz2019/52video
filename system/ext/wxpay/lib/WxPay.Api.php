...
class WxPayApi
{
	 ...
	 */
	public static function unsendredpack($inputObj, $timeOut = 6)
	{
		...
		$response = self::postXmlCurlforred($xml, $url, true, $timeOut);
	 ...
	 * @throws WxPayException
	 */
	private static function postXmlCurlforred($xml, $url, $useCert = false, $second = 30)
	{		
		$ch = curl_init();
		//设置超时
		curl_setopt($ch, CURLOPT_TIMEOUT, $second);
