jQuery(function(e) {
    ...
    function() {
        ...
        var a = {
            mp4: "style/qixi/images/kuxuan.mp4",
            webm: "style/qixi/images/kuxuan.webm",
            ogv: "style/qixi/images/kuxuan.mp4",
            opacity: 1,
            zIndex: 0,
            fullscreen: !0,
            muted: "muted"
        };
        e(".hero-unit").videoBG(a),
        e(window).resize(function() {
            e(".videoBG_wrapper").width("100%"),
            e(".videoBG_wrapper").height("100%")
        }),
        e(".up, .off").click(function() {
            e(".videoBG video").toggleVolume(),
            e(this).toggleClass("up off")
        }),
