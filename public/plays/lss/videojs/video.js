...
(function() {
    ...
    t.k = function(a, c, d) {
        if (t.Bc(a)) {
            ...
            if (e.C) {
                ...
                } else for (g in e.C) c = g, e.C[c] = [], t.pc(a, c);
            }
        }
    };
    t.pc = function(a, c) {
    ...
    t.l = function(a, c) {
        var d = t.Bc(a) ? t.getData(a) :{}, e = a.parentNode || a.ownerDocument;
        "string" === typeof c && (c = {
            type:c,
            target:a
        });
        c = t.zc(c);
        d.W && d.W.call(a, c);
        if (e && !c.Lb() && c.bubbles !== l) t.l(e, c); else if (!e && !c.defaultPrevented && (d = t.getData(c.target), 
        c.target[c.type])) {
            d.disabled = f;
    ...
    t.ye = function(a, c) {
        ...
        e.onload = p, e.onerror = q, e.onprogress = m(), e.ontimeout = m()) :(h = "file:" == d.protocol || "file:" == g.protocol, 
    ...
    t.a = t.ta.extend({
        i:function(a, c, d) {
            ...
            if (c.Qc !== l) {
                var e, g;
                this.j().reportUserActivity && (e = t.bind(this.j(), this.j().reportUserActivity), 
    ...
    s.removeChild = function(a) {
        ...
        if (a && this.O) {
            for (var c = l, d = this.O.length - 1; 0 <= d; d--) if (this.O[d] === a) {
                c = f;
                this.O.splice(d, 1);
                break;
            }
    ...
    s.Dc = function() {
        ...
        if (d = c.children) if (h = function(d, e) {
            c[d] !== b && (e = c[d]);
            e !== l && (a[d] = a.U(d, e));
        }, t.h.isArray(d)) for (var j = 0; j < d.length; j++) e = d[j], "string" == typeof e ? (g = e, 
        e = {}) :g = e.name, h(g, e); else t.h.X(d, h);
    };
    s.S = r("");
    s.c = function(a, c, d) {
        var e, g, h;
        "string" === typeof a || t.h.isArray(a) ? t.c(this.b, a, t.bind(this, c)) :(e = t.bind(this, d), 
        h = this, g = function() {
            h.k(a, c, e);
        }, g.p = e.p, this.c("dispose", g), d = function() {
            h.k("dispose", g);
        }, d.p = e.p, a.nodeName ? (t.c(a, c, e), t.c(a, "dispose", d)) :"function" === typeof a.c && (a.c(c, e), 
        a.c("dispose", d)));
        return this;
    };
    s.k = function(a, c, d) {
        !a || "string" === typeof a || t.h.isArray(a) ? t.k(this.b, a, c) :(d = t.bind(this, d), 
        this.k("dispose", d), a.nodeName ? (t.k(a, c, d), t.k(a, "dispose", d)) :(a.k(c, d), 
        a.k("dispose", d)));
        return this;
    };
    s.Q = function(a, c, d) {
        var e, g, h;
        "string" === typeof a || t.h.isArray(a) ? t.Q(this.b, a, t.bind(this, c)) :(e = t.bind(this, d), 
        g = this, h = function() {
            g.k(a, c, h);
    ...
    function G(a) {
        ...
        a.c("touchmove", function(a) {
            1 < a.touches.length ? g = l :d && (j = a.touches[0].pageX - d.pageX, p = a.touches[0].pageY - d.pageY, 
            q = Math.sqrt(j * j + p * p), 22 < q && (g = l));
        });
        h = function() {
            g = l;
        };
    ...
    s.update = function() {
        if (this.b) {
            var a, c = this.Hb(), d = this.handle, e = this.td;
            isNaN(c) && (c = 0);
            a = c;
            if (d) {
    ...
    s.ea = function(a) {
        if (37 == a.which || 40 == a.which) a.preventDefault(), this.Xc(); else if (38 == a.which || 39 == a.which) a.preventDefault(), 
        this.Yc();
    };
    s.$a = function() {
    ...
    t.J.prototype.selected = function(a) {
        a ? (this.n("vjs-selected"), this.b.setAttribute("aria-selected", f)) :(this.r("vjs-selected"), 
    ...
    function Q(a, c, d) {
        ...
        d && (a.uc = d.type, d.src == a.F.src && 0 < a.F.currentTime && (e.startTime = a.F.currentTime), 
        a.F.src = d.src);
    ...
    function S(a, c) {
        if (a.o && a.o.na) try {
            ...
            throw a.o[c] === b ? t.log("Video.js: " + c + " method not defined for " + a.gb + " playback technology.", d) :"TypeError" == d.name ? (t.log("Video.js: " + c + " unavailable on " + a.gb + " playback technology element.", d), 
            a.o.na = l) :t.log(d), d;
        }
    }
    s.play = function() {
    ...
    s.volume = function(a) {
        if (a !== b) return a = Math.max(0, Math.min(1, parseFloat(a))), this.F.volume = a, 
        T(this, "setVolume", a), t.je(a), this;
    ...
    s.requestFullscreen = function() {
        ...
        })), this.b[a.requestFullscreen]()) :this.o.Ha() ? T(this, "enterFullScreen") :(this.yc(), 
        this.l("fullscreenchange"));
        return this;
    };
    s.requestFullScreen = function() {
    ...
    s.exitFullscreen = function() {
        var a = t.Ra.Gb;
        this.isFullscreen(l);
        if (a) document[a.exitFullscreen](); else this.o.Ha() ? T(this, "exitFullScreen") :(this.Db(), 
        this.l("fullscreenchange"));
        return this;
    };
    ...
    s.src = function(a) {
        ...
        t.h.isArray(a) ? U(this, a) :"string" === typeof a ? this.src({
            src:a
        }) :a instanceof Object && (a.type && !window.videojs[this.gb].canPlaySource(a) ? U(this, [ a ]) :(this.F.src = a.src, 
        this.uc = a.type || "", this.H(function() {
    ...
    s.controls = function(a) {
        return a !== b ? (a = !!a, this.yb !== a && ((this.yb = a) ? (this.r("vjs-controls-disabled"), 
        this.n("vjs-controls-enabled"), this.l("controlsenabled")) :(this.r("vjs-controls-enabled"), 
        this.n("vjs-controls-disabled"), this.l("controlsdisabled"))), this) :this.yb;
    };
    t.Player.prototype.Wb;
    s = t.Player.prototype;
    s.usingNativeControls = function(a) {
        return a !== b ? (a = !!a, this.Wb !== a && ((this.Wb = a) ? (this.n("vjs-using-native-controls"), 
        this.l("usingnativecontrols")) :(this.r("vjs-using-native-controls"), this.l("usingcustomcontrols"))), 
        this) :this.Wb;
    };
    s.da = k;
    s.error = function(a) {
    ...
    s.userActive = function(a) {
        return a !== b ? (a = !!a, a !== this.Vb && ((this.Vb = a) ? (this.sa = f, this.r("vjs-user-inactive"), 
        this.n("vjs-user-active"), this.l("useractive")) :(this.sa = l, this.o && this.o.Q("mousemove", function(a) {
            a.stopPropagation();
            a.preventDefault();
        }), this.r("vjs-user-active"), this.n("vjs-user-inactive"), this.l("userinactive"))), 
        this) :this.Vb;
    };
    ...
    t.pb = t.J.extend({
        rc:"button",
        i:function(a, c) {
            var d = this.label = c.rate, e = this.Oc = parseFloat(d, 10);
            c.label = d;
            c.selected = 1 === e;
            t.J.call(this, a, c);
    ...
    t.q = t.a.extend({
        i:function(a, c, d) {
            ...
            this.featuresTimeupdateEvents || (a = this.d, this.Nb = f, this.c(a, "play", this.$c), 
            this.c(a, "pause", this.fb), this.Q("timeupdate", function() {
    ...
    t.q.dd = function(a) {
        ...
        a.Rc = function(c) {
            for (var d = a.Vc || [], e, g = 0; g < d.length; g++) if (e = d[g].Sa(c)) return d[g];
            return k;
        };
        a.oc = function(c) {
            var d = a.Rc(c);
    ...
    s.e = function() {
        ...
        if (!c || this.movingMediaElementInDOM === l) c ? (d = c.cloneNode(l), t.g.Bb(c), 
        c = d, a.I = k) :(c = t.e("video"), t.Sc(c, t.h.z(a.se || {}, {
            id:a.id() + "_html5_api",
            "class":"vjs-tech"
    ...
    s.Fd = function(a) {
        "error" == a.type && this.error() ? this.j().error(this.error().code) :(a.bubbles = l, 
        this.j().l(a));
    };
    s.play = function() {
        this.b.play();
    ...
    t.f = t.q.extend({
        i:function(a, c, d) {
            ...
            var g = this.b = t.e("div", {
                id:a.id() + "_temp_flash"
            }), h = a.id() + "_flash_api", j = a.m, j = t.h.z({
    ...
    function Y(a, c, d) {
        for (var e = a.Ia, g = 0, h = e.length, j, p; g < h; g++) j = e[g], j.id() === c ? (j.show(), 
        p = j) :d && j.L() == d && 0 < j.mode() && j.disable();
    ...
    function oa(a) {
        0 === a.qa && a.load();
        0 === a.oa && (a.d.c("timeupdate", t.bind(a, a.update, a.K)), a.d.c("ended", t.bind(a, a.reset, a.K)), 
        ("captions" === a.G || "subtitles" === a.G) && a.d.ma("textTrackDisplay").U(a));
    }
    s.vc = function() {
    ...
    s.load = function() {
        0 === this.qa && (this.qa = 1, t.ye(this.Wc, t.bind(this, function(a, c, d) {
            if (a) this.error = a, this.qa = 3, this.l("error"); else {
                var e, g;
                a = d.split("\n");
                c = "";
                d = 1;
                for (var h = a.length; d < h; d++) if (c = t.trim(a[d])) {
                    -1 == c.indexOf("-->") ? (e = c, c = t.trim(a[++d])) :e = this.ca.length;
                    e = {
                        id:e,
    ...
    s.update = function() {
        if (0 < this.ca.length) {
            ...
            if (this.Qb === b || a < this.Qb || this.Za <= a) {
                ...
                for (;;) {
                    q = c[w];
                    if (q.Aa <= a) e = Math.max(e, q.Aa), q.Qa && (q.Qa = l); else if (a < q.startTime) {
                        if (d = Math.min(d, q.startTime), q.Qa && (q.Qa = l), !g) break;
                    } else g ? (h.splice(0, 0, q), p === b && (p = w), j = w) :(h.push(q), j === b && (j = w), 
                    p = w), d = Math.min(d, q.Aa), e = Math.max(e, q.startTime), q.Qa = f;
    ...
    t.T.prototype.ya = function() {
        ...
        c.L() === this.G && a.push(new t.aa(this.d, {
            track:c
        }));
        return a;
    };
    ...
    s.za = function() {
        for (var a = this.d.textTracks(), c = 0, d = a.length, e, g, h = this.P = []; c < d; c++) if (e = a[c], 
        e.L() == this.G) if (0 === e.readyState()) e.load(), e.c("loaded", t.bind(this, this.za)); else {
            g = e;
            break;
        }
        a = this.Da;
    ...
    if ("undefined" !== typeof window.JSON && "function" === typeof window.JSON.parse) t.JSON = window.JSON; else {
        ...
        t.JSON.parse = function(a, c) {
            function d(a, e) {
                var j, p, q = a[e];
                if (q && "object" === typeof q) for (j in q) Object.prototype.hasOwnProperty.call(q, j) && (p = d(q, j), 
                p !== b ? q[j] = p :delete q[j]);
                return c.call(a, e, q);
            }
            var e;
            a = String(a);
...
videojs.options.flash.swf = LSS_SITE + "/lss/videojs/video-js.swf";

var lssVideoPlayer, lssVideoContainer, lssVideoId, lssVideoHtml, lssVodeoAutoStart, lssCssInterval;

function lssCssLoad(obj) {
    if (document.getElementById("lssVideoCss") && lssVideoPlayer) {
        clearInterval(lssCssInterval);
        if (lssVodeoAutoStart == true) {
            lssVideoPlayer.play();
        }
    }
}
...
function lssplayerRun(conf) {
    if (!conf.hlsUrl || conf.hlsUrl == "") {
        console.log("缺少必要的参数hlsUrl");
        return;
    }
    lssVideoContainer = conf.container;
    var mode = /^\d{0,6}(\%)?$/;
    var width = mode.test(conf.player.html5Width) ? conf.player.html5Width :"100%";
    var height = mode.test(conf.player.html5Height) ? conf.player.html5Height :"100%";
    var poster = typeof conf.player.poster != "undefined" ? conf.player.poster :"";
    lssVodeoAutoStart = typeof conf.player.autostart == "boolean" ? conf.player.autostart :false;
    lssVideoId = "videoJs_" + conf.uin;
    lssVideoHtml = '		  <video id="' + lssVideoId + '" class="video-js vjs-default-skin vjs-big-play-centered" preload="none" controls="controls" width="' + width + '" height="' + height + '" poster="' + poster + '" data-setup="{}" webkit-playsinline="true" playsinline=true x-webkit-airplay=false>			<source src="' + conf.hlsUrl + '" type="application/x-mpegURL" />			<p class="vjs-no-js">To view this video please enable JavaScript</p>		  </video>	';
    $("#" + lssVideoContainer).html(lssVideoHtml);
    lssVideoPlayer = _V_(lssVideoId);
    var link = document.createElement("link");
    link.id = "lssVideoCss";
    link.type = "text/css";
    link.rel = "stylesheet";
    link.href = LSS_SITE + "/lss/videojs/video-js.css";
    link.rel = "stylesheet";
    document.getElementsByTagName("head")[0].appendChild(link);
    lssCssInterval = setInterval("lssCssLoad()", 100);
    //播放
