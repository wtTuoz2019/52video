/* KindEditor 4.1.7 (2013-04-21), Copyright (C) kindsoft.net, Licence: http://www.kindsoft.net/license.php */ (function(A, o) {
    ...
    function va(a) {
        ...
        return a.replace(/rgb\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/gi, function(a, d, e, g) {
            return "#" + b(d) + b(e) + b(g);
        });
    }
    function u(a, b) {
    ...
    function S(a, b, c, d, e) {
        var c = c || "", d = j(d, !1), e = j(e, "	"), g = "xx-small,x-small,small,medium,large,x-large,xx-large".split(","), a = a.replace(/(<(?:pre|pre\s[^>]*)>)([\s\S]*?)(<\/pre>)/gi, function(a, b, c, d) {
            return b + c.replace(/<(?:br|br\s[^>]*)>/gi, "\n") + d;
        }), a = a.replace(/<(?:br|br\s[^>]*)\s*\/?>\s*<\/p>/gi, "</p>"), a = a.replace(/(<(?:p|p\s[^>]*)>)\s*(<\/p>)/gi, "$1<br />$2"), a = a.replace(/\u200B/g, ""), a = a.replace(/\u00A9/g, "&copy;"), h = {};
        b && (m(b, function(a, b) {
            for (var c = a.split(","), d = 0, e = c.length; d < e; d++) h[c[d]] = u(b);
        }), h.script || (a = a.replace(/(<(?:script|script\s[^>]*)>)([\s\S]*?)(<\/script>)/gi, "")), 
        h.style || (a = a.replace(/(<(?:style|style\s[^>]*)>)([\s\S]*?)(<\/style>)/gi, "")));
    ...
    function za(a, b) {
        ...
        function f(a, b) {
            ...
            if (i = /#((?:[\w\-]|\\.)+)$/.exec(a)) c = e(i[1], k, b); else if (i = /\.((?:[\w\-]|\\.)+)$/.exec(a)) c = g(i[1], k, b); else if (i = /\[((?:[\w\-]|\\.)+)\]/.exec(a)) c = h(i[1].toLowerCase(), null, k, b); else if (i = /\[((?:[\w\-]|\\.)+)\s*=\s*['"]?((?:\\.|[^'"]+)+)['"]?\]/.exec(a)) {
                c = i[1].toLowerCase();
                i = i[2];
    ...
    function Ma(a, b, c) {
        ...
        function g(e, l) {
            for (var j = e.firstChild, o; j; ) {
                ...
                c && f.push(j); else {
                    ...
                    if (g(j, q) === !1) return !1;
                } else if (j.nodeType == 3 && (j = j == k.startContainer ? d(j, k.startOffset, j.nodeValue.length) :j == k.endContainer ? d(j, 0, k.endOffset) :d(j, 0, j.nodeValue.length), 
                b)) try {
                    l.appendChild(j);
                } catch (s) {}
                j = o;
        ...
        if (l.nodeType == 3) return l = d(l, a.startOffset, a.endOffset), b && j.appendChild(l), 
        e(), b ? j :a;
        g(l, j);
        c && a.up().collapse(!0);
    ...
    function rb(a, b) {
        ...
        if (a.nodeType == 1 && a.childNodes.length > 0) {
            ...
            if (!g) return d;
            if (f(g).name === "head") return b === 1 && (e = !0), b === 2 && (e = !1), d.collapse(e), 
            d;
            if (g.nodeType == 1) {
                var h = f(g), i;
    ...
    function Sa(a) {
        ...
        d.mousedown(function(a) {
            function i(a) {
                a.preventDefault();
                var b = f(T(a.target)), e = Q((b.data("pos-x") || 0) + a.pageX - q), a = Q((b.data("pos-y") || 0) + a.pageY - s);
    ...
    function Ya(a, b) {
        ...
        d.onload = d.onreadystatechange = function() {
            if (!this.readyState || this.readyState === "loaded") b && b(), d.onload = d.onreadystatechange = null, 
            c.removeChild(d);
        };
    }
    function Db(a) {
        ...
        if (!(l && d !== "br") && (!ea || !(z < 3 && d !== "p")) && !(La && z < 9)) {
            ...
            f(c).keyup(function(e) {
                if (!(e.which != 13 || e.shiftKey || e.ctrlKey || e.altKey) && d != "br") if (ea) {
                    ...
                    i && i.text() == "" && (i.remove(!0), b.cmd.range.selectNodeContents(e[0]).collapse(!0), 
                    b.cmd.select());
                } else if (b.cmd.selection(), e = a(b.cmd.range), !(e == "marquee" || e == "select")) if (g[e] || P(c, "formatblock", "<p>"), 
                e = b.cmd.commonAncestor("div")) {
    ...
    function $b() {
        ...
        f(b).keydown(function(c) {
            if (c.which == 9) if (c.preventDefault(), a.afterTab) a.afterTab.call(a, c); else {
                ...
                d.shrink();
                d.collapsed && d.startContainer.nodeType == 1 && (d.insertNode(f("@&nbsp;", b)[0]), 
                c.select());
                a.insertHtml("&nbsp;&nbsp;&nbsp;&nbsp;");
            }
        });
    ...
    function X(a) {
        return B(a.replace(/<span [^>]*id="?__kindeditor_bookmark_\w+_\d+__"?[^>]*><\/span>/gi, ""));
    }
    function $a(a) {
    ...
    if (!A.KindEditor) {
        ...
        f.basePath = function() {
            for (var a = document.getElementsByTagName("script"), b, c = 0, d = a.length; c < d; c++) if (b = a[c].src || "", 
            /kindeditor[\w\-\.]*\.js/.test(b)) return b.substring(0, b.lastIndexOf("/") + 1);
            return "";
        }();
        f.options = {
            designMode:!0,
        ...
        var db = !1, Nb = u("8,9,13,32,46,48..57,59,61,65..90,106,109..111,188,190..192,219..222"), q = u("33..40"), ab = {};
        m(Nb, function(a, b) {
            ab[a] = b;
        });
        m(q, function(a, b) {
        ...
        E(D, {
            ...
            pos:function() {
                ...
                if (a) if (a.getBoundingClientRect) a = a.getBoundingClientRect(), c = ba(this.doc), 
                b = a.left + c.x, c = a.top + c.y; else for (;a; ) b += a.offsetLeft, c += a.offsetTop, 
                a = a.offsetParent;
                return {
                    x:Q(b),
                    y:Q(c)
        ...
        E(L, {
            ...
            commonAncestor:function() {
                ...
                for (var b = a(this.startContainer), c = a(this.endContainer), d = 0, e = b.length, g = c.length, f, i; ++d; ) if (f = b[e - d], 
                i = c[g - d], !f || !i || f !== i) break;
                return b[e - d + 1];
            },
            ...
            insertNode:function(a) {
                ...
                if (a.nodeName.toLowerCase() === "#document-fragment") g = a.firstChild, f = a.lastChild, 
                k = a.childNodes.length;
                b.nodeType == 1 ? (i = b.childNodes[c]) ? (b.insertBefore(a, i), b === d && (e += k)) :b.appendChild(a) :b.nodeType == 3 && (c === 0 ? (b.parentNode.insertBefore(a, b), 
                b.parentNode === d && (e += k)) :c >= b.nodeValue.length ? b.nextSibling ? b.parentNode.insertBefore(a, b.nextSibling) :b.parentNode.appendChild(a) :(i = c > 0 ? b.splitText(c) :b, 
                b.parentNode.insertBefore(a, i), b === d && (d = i, e -= c)));
        ...
        E(na, {
            ...
            select:function(a) {
                ...
                if (l) try {
                    i = c.get(!0), i.select();
                } catch (r) {} else k && c.collapse(!1), i = c.get(!0), b.removeAllRanges(), b.addRange(i), 
            ...
            wrap:function(a) {
                var b = this.range, c;
                c = f(a, this.doc);
                if (b.collapsed) return b.shrink(), b.insertNode(c[0]).selectNodeContents(c[0]), 
                this;
                if (c.isBlock()) {
            ...
            split:function(a, b) {
                ...
                if (k) d = d.createElement("span"), c.cloneRange().collapse(!a).insertNode(d), a ? e.setStartBefore(i.firstChild).setEnd(g, h) :e.setStart(g, h).setEndAfter(i.lastChild), 
                g = e.extractContents(), h = g.firstChild, k = g.lastChild, a ? (e.insertNode(g), 
                c.setStartAfter(k).setEndBefore(d)) :(i.appendChild(g), c.setStartBefore(d).setEndBefore(h)), 
                e = d.parentNode, e == c.endContainer && (i = f(d).prev(), g = f(d).next(), i && g && i.type == 3 && g.type == 3 ? c.setEnd(i[0], i[0].nodeValue.length) :a || c.setEnd(c.endContainer, c.endOffset - 1)), 
                e.removeChild(d);
                return this;
            },
            remove:function(a) {
            ...
            val:function(a) {
                ...
                if (a === "fontfamily" || a === "fontname") return c = tb(b, "fontname"), c = c.replace(/['"]/g, ""), 
                c.toLowerCase();
                if (a === "formatblock") {
                    c = tb(b, a);
                ...
                if (a === "hilitecolor") return (a = this.commonNode({
                    "*":".background-color"
                })) && (c = a.css("background-color")), c = va(c), c === "" && (c = "default"), 
                c.toLowerCase();
                return c;
            },
            toggle:function(a, b) {
        ...
        E(pa, R, {
            init:function(a) {
                ...
                var d = j(a.themesPath, ""), e = a.bodyClass, g = a.cssPath, h = a.cssData, i = location.host.replace(/:\d+/, "") !== document.domain, k = "document.open();" + (i ? 'document.domain="' + document.domain + '";' :"") + "document.close();", k = l ? ' src="javascript:void(function(){' + encodeURIComponent(k) + '}())"' :"";
            ...
            html:function(a, b) {
                ...
                if (this.designMode) {
                    ...
                    this.beforeGetHtml && (a = this.beforeGetHtml(a)), ea && a == "<br />" && (a = ""), 
                    a;
                    this.beforeSetHtml && (a = this.beforeSetHtml(a));
                    l && z >= 9 && (a = a.replace(/(<.*?checked=")checked(".*>)/gi, "$1$2"));
                    f(c).html(a);
            ...
            design:function(a) {
                if (a === o ? !this.designMode :a) {
                    ...
                    this.iframe.show();
                } else if (this.designMode) a = this.html(), this.designMode = !1, this.html(a), 
                this.iframe.hide(), this.textarea.show();
                return this.focus();
            },
            focus:function() {
        ...
        E(qa, R, {
            ...
            addItem:function(a) {
                if (a.title === "-") this.div.append(f('<div class="ke-menu-separator"></div>')); else {
                    var b = f('<div class="ke-menu-item" unselectable="on"></div>'), c = f('<div class="ke-inline-block ke-menu-item-left"></div>'), d = f('<div class="ke-inline-block ke-menu-item-right"></div>'), e = s(a.height), g = j(a.iconClass, "");
                    this.div.append(b);
        ...
        ta.prototype = {
            ...
            create:function() {
                ...
                f.each(b.items, function(a, c) {
                    c == "|" ? j.push('<span class="ke-inline-block ke-separator"></span>') :c == "/" ? j.push('<div class="ke-hr"></div>') :(j.push('<span class="ke-outline" data-name="' + c + '" title="' + b.lang(c) + '" unselectable="on">'), 
                ...
                }, f(A).bind("resize", b._fullscreenResizeHandler), h.select("fullscreen"), k.first().css("visibility", "hidden"), 
                k.last().css("visibility", "hidden")) :(ea && f(A).bind("scroll", function() {
                    b._scrollPos = ba();
                }), b.resizeType > 0 ? Sa({
                    moveEl:g,
                    clickEl:k,
            ...
            resize:function(a, b, c) {
                ...
                editHeight = editHeight < this.minHeight ? this.minHeight :editHeight, this.edit.setHeight(editHeight), 
                c)) this.height = s(b);
                return this;
            },
            select:function() {
            ...
            text:function(a) {
                return a === o ? B(this.html().replace(/<(?!img|embed).*?>/gi, "").replace(/&nbsp;/gi, " ")) :this.html(C(a));
            },
            isEmpty:function() {
            ...
            count:function(a) {
                ...
                if (a === "text") return this.text().replace(/<(?:img|embed).*?>/gi, "K").replace(/\r\n|\n|\r/g, "").length;
                return 0;
            },
            exec:function(a) {
            ...
            addBookmark:function(a) {
                ...
                b.designMode && !this._firstAddBookmark ? (b = this.cmd.range, a = b.createBookmark(!0), 
                a.html = $a(c.innerHTML), b.moveToBookmark(a)) :a = {
                    html:d
                };
            ...
            createMenu:function(a) {
                ...
                a.selectedColor !== o ? (a.cls = "ke-colorpicker-" + this.themeType, a.noColor = this.lang("noColor"), 
                this.menu = Bb(a)) :(a.cls = "ke-menu-" + this.themeType, a.centerLineMode = !1, 
                this.menu = Wa(a));
                return this.menu;
            },
            hideMenu:function() {
        ...
        Eb("core", function(a) {
            ...
            b.clickToolbar("source", function() {
                b.edit.designMode ? (b.toolbar.disableAll(!0), b.edit.design(!1), b.toolbar.select("source")) :(b.toolbar.disableAll(!1), 
                b.edit.design(!0), b.toolbar.unselect("source"), b.cmd.selection());
            ...
            b.afterCreate(function() {
                function c() {
                    ...
                    }), a("span.Apple-style-span", j).remove(!0), a("span.Apple-tab-span", j).remove(!0), 
                    a("span[style]", j).each(function() {
                        a(this).css("white-space") == "nowrap" && a(this).remove(!0);
                    }), a("meta", j).remove());
                    var d = j[0].innerHTML;
                    j.remove();
                    d !== "" && (W && (d = d.replace(/(<br>)\1/gi, "$1")), b.pasteType === 2 && (d = d.replace(/(<(?:p|p\s[^>]*)>) *(<\/p>)/gi, ""), 
                    /schemas-microsoft-com|worddocument|mso-\w+/i.test(d) ? d = lb(d, b.filterMode ? b.htmlTags :a.options.htmlTags) :(d = S(d, b.filterMode ? b.htmlTags :null), 
                    d = b.beforeSetHtml(d))), b.pasteType === 1 && (d = d.replace(/&nbsp;/gi, " "), 
                    d = d.replace(/\n\s*\n/g, "\n"), d = d.replace(/<br[^>]*>/gi, "\n"), d = d.replace(/<\/p><p[^>]*>/gi, "\n"), 
            ...
            b.beforeGetHtml(function(a) {
                l && z <= 8 && (a = a.replace(/<div\s+[^>]*data-ke-input-tag="([^"]*)"[^>]*>([\s\S]*?)<\/div>/gi, function(a, b) {
                    return unescape(b);
                ...
                return a.replace(/(<(?:noscript|noscript\s[^>]*)>)([\s\S]*?)(<\/noscript>)/gi, function(a, b, c, d) {
                    ...
                    var a = H(a), b = aa(a.style || ""), c = nb(a["data-ke-tag"]);
            ...
            b.beforeSetHtml(function(a) {
                l && z <= 8 && (a = a.replace(/<input[^>]*>|<(select|button)[^>]*>[\s\S]*?<\/\1>/gi, function(a) {
                    var b = H(a);
