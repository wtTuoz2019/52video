...
(function() {
    ...
    function Ja(a, b) {
        for (var c = "{", d = !1, e, f, g, h, i, j = []; (c = a.indexOf(c)) !== -1; ) {
            ...
            if (d) {
                ...
                if (f.length) f = f.join(":"), g = /\.([0-9])/, h = T.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] :-1, 
                e !== null && (e = A.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep :""))) :e = Oa(f, e);
            }
            j.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" :"{";
    ...
    var y, B = document, K = window, W = Math, r = W.round, V = W.floor, ta = W.ceil, u = W.max, C = W.min, O = W.abs, X = W.cos, aa = W.sin, ma = W.PI, ha = ma * 2 / 360, Ba = navigator.userAgent, Jb = K.opera, ya = /(msie|trident)/i.test(Ba) && !Jb, hb = B.documentMode === 8, ib = /AppleWebKit/.test(Ba), La = /Firefox/.test(Ba), Kb = /(Mobile|Android|Windows Phone)/.test(Ba), Ca = "http://www.w3.org/2000/svg", ca = !!B.createElementNS && !!B.createElementNS(Ca, "svg").createSVGRect, Ob = La && parseInt(Ba.split("Firefox/")[1], 10) < 4, fa = !ca && !ya && !!B.createElement("canvas").getContext, $a, ab, Lb = {}, yb = 0, fb, T, Oa, za, zb, E, na = function() {
        return y;
            ...
            init:function(b) {
                ...
                a.each([ "cur", "_default", "width", "height", "opacity" ], function(b, e) {
                    ...
                    (g = f[e]) && (f[e] = function(a) {
                        var c, a = b ? a :this;
                        if (a.prop !== "align") return c = a.elem, c.attr ? c.attr(a.prop, e === "cur" ? y :a.now) :g.apply(this, arguments);
                    });
                });
                ...
                a.fn.highcharts = function() {
                    ...
                    if (this[0]) {
                        ...
                        c = b[0];
                        if (c !== y) c.chart = c.chart || {}, c.chart.renderTo = this[0], new A[a](c, b[1]), 
                        g = this;
    ...
    U && U.init.call(U, zb);
    var kb = F.adapterRun, Rb = F.getScript, Ma = F.inArray, o = A.each = F.each, lb = F.grep, Sb = F.offset, Ua = F.map, H = F.addEvent, Z = F.removeEvent, I = F.fireEvent, Tb = F.washMouseEvent, mb = F.animate, db = F.stop;
    T = {
    ...
    Db();
    var Ub = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/, Vb = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/, Wb = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/, oa = function(a) {
        var b = [], c, d;
        (function(a) {
    ...
    Q.prototype = {
        ...
        colorGradient:function(a, b, c) {
            ...
            if (f) {
                ...
                v = v.join(",");
                h[v] ? a = h[v].attr("id") :(g.id = a = "highcharts-" + yb++, h[v] = i = d.createElement(f).attr(g).add(d.defs), 
                i.stops = [], o(j, function(a) {
                    a[1].indexOf("rgba") === 0 ? (e = oa(a[1]), k = e.get("rgb"), l = e.get("a")) :(k = a[1], 
                    l = 1);
        ...
        applyTextShadow:function(a) {
            ...
            f ? L(b, e) :(this.fakeTS = !0, this.ySetter = this.xSetter, c = [].slice.call(b.getElementsByTagName("tspan")), 
            o(a.split(/\s?,\s?/g), function(a) {
                var d = b.firstChild, e, f, a = a.split(" ");
                e = a[a.length - 1];
                (f = a[a.length - 2]) && o(c, function(a, c) {
                    var g;
                    c === 0 && (a.setAttribute("x", b.getAttribute("x")), c = b.getAttribute("y"), a.setAttribute("y", c || 0), 
    ...
    Q.prototype["stroke-widthSetter"] = Q.prototype.strokeSetter = function(a, b, c) {
        ...
        Q.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]), 
    ...
    ua.prototype = {
        ...
        buildText:function(a) {
            ...
            !f && !n && !v && e.indexOf(" ") === -1 ? b.appendChild(B.createTextNode(t(e))) :(h = /<.*style="([^"]+)".*>/, 
            i = /<.*href="(http[^"]+)".*>/, S && S.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) :[ e ], 
            e[e.length - 1] === "" && e.pop(), o(e, function(e, f) {
                    ...
                    if (e !== "" || g.length === 1) {
                        ...
                        if (e !== " ") {
                            ...
                            if (l) {
                                ...
                                S = a.getBBox(!0), q = S.width, !ca && c.forExport && (q = c.measureSpanWidth(s.firstChild.data, a.styles)), 
                                S = q > l, w === void 0 && (w = S), v && w ? (C /= 2, z === "" || !S && C < .5 ? n = [] :(S && (w = !0), 
                                z = e.substring(0, z.length + (S ? -1 :1) * ta(C)), n = [ z + (l > 3 ? "…" :"") ], 
                                s.removeChild(s.firstChild))) :!S || n.length === 1 ? (n = u, u = [], n.length && (r++, 
                                s = B.createElementNS(Ca, "tspan"), J(s, {
                                    dy:y,
                                    x:j
                                }), p && J(s, "style", p), b.appendChild(s)), q > l && (l = q)) :(s.removeChild(s.firstChild), 
                                u.unshift(n.pop())), n.length && s.appendChild(B.createTextNode(n.join(" ").replace(/- /g, "-")));
        ...
        symbol:function(a, b, c, d, e, f) {
            ...
            }, j = a.match(i)[1], a = Lb[j] || f && f.width && f.height && [ f.width, f.height ], 
            g = this.image(j).attr({
                x:b,
                y:c
        ...
        symbols:{
            ...
            arc:function(a, b, c, d, e) {
                var f = e.start, c = e.r || c || d, g = e.end - .001, d = e.innerR, h = e.open, i = X(f), j = aa(f), k = X(g), g = aa(g), e = e.end - f < ma ? 0 :1;
        ...
        label:function(a, b, c, d, e, f, g, h, i) {
            function j() {
                ...
                if (D) {
                    if (!s) a = r(-N * t) + B, b = (h ? -A :0) + B, n.box = s = d ? m.symbol(d, a, b, n.width, n.height, G) :m.rect(a, b, n.width, n.height, 0, G[Qb]), 
                    s.attr("fill", P).add(n);
                    s.isImg || s.attr(x({
                        width:r(n.width),
                        height:r(n.height)
            ...
            function k() {
                var a = n.styles, a = a && a.textAlign, b = w + t * (1 - N), c;
                c = h ? 0 :A;
            ...
            var m = this, n = m.g(i), v = m.text("", 0, 0, g).attr({
                zIndex:1
            }), s, p, N = 0, t = 3, w = 0, ga, u, Ab, C, B = 0, G = {}, A, D;
            n.onAdd = function() {
                v.add(n);
                n.attr({
                    text:a || a === 0 ? a :"",
    ...
    if (!ca && !fa) {
        F = {
            ...
            pathToVML:function(a) {
                for (var b = a.length, c = []; b--; ) if (ra(a[b])) c[b] = r(a[b] * 10) - 5; else if (a[b] === "Z") c[b] = "x"; else if (c[b] = a[b], 
        ...
        var Na = {
            ...
            color:function(a, b, c, d) {
                ...
                if (i) {
                    ...
                    n = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, t = 'angle="' + (90 - W.atan((m - a) / (n - c)) * 180 / ma) + '"', 
                    q(); else {
                        var j = m.r, u = j * 2, y = j * 2, r = m.cx, x = m.cy, C = b.radialReference, z, j = function() {
                            C && (z = d.getBBox(), r += (C[0] - z.x) / z.width - .5, x += (C[1] - z.y) / z.height - .5, 
                            u *= C[2] / z.width, y *= C[2] / z.height);
            ...
            symbols:{
                arc:function(a, b, c, d, e) {
                    var f = e.start, g = e.end, h = e.r || c || d, c = e.innerR, d = X(f), i = aa(f), j = X(g), k = aa(g);
                    if (g - f === 0) return [ "x" ];
    ...
    Ta.prototype = {
        addLabel:function() {
            ...
            q(d) ? d && d.attr({
                text:b
            }) :(this.labelLength = (this.label = d = q(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(z(g.style)).add(a.labelGroup) :null) && d.getBBox().width, 
            this.rotation = 0);
        },
        ...
        handleOverflow:function(a) {
            ...
            if (h) h < 0 && c - i * j < f ? m = r(c / X(h * ha) - f) :h > 0 && c + i * j > e && (m = r((d - c) / X(h * ha))); else if (d = c + (1 - i) * j, 
            c - i * j < f ? k = a.x + k * (1 - i) - f :d > e && (k = e - a.x + k * i, l = -1), 
            k = C(b.slotWidth, k), k < b.slotWidth && b.labelAlign === "center" && (a.x += l * (b.slotWidth - k - i * (b.slotWidth - C(j, k)))), 
            j > k || b.autoRotation && g.styles.width) m = k;
            if (m) {
                n.width = m;
        ...
        render:function(a, b, c) {
            ...
            if (m && N) w === "inside" && (N = -N), d.opposite && (N = -N), h = this.getMarkPath(x, r, N, m * z, g, f), 
            n ? n.animate({
                d:h,
                opacity:c
            ...
            if (i && !isNaN(x)) i.xy = r = this.getLabelPosition(x, r, i, g, k, u, a, ga), this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? q = !1 :g && !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && this.handleOverflow(r), 
            ga && a % ga && (q = !1), q && !isNaN(r.y) ? (r.opacity = c, i[this.isNew ? "attr" :"animate"](r), 
    ...
    A.PlotLineOrBand.prototype = {
        render:function() {
            var a = this, b = a.axis, c = b.horiz, d = a.options, e = d.label, f = a.label, g = d.width, h = d.to, i = d.from, j = q(i) && q(h), k = d.value, l = d.dashStyle, m = a.svgElem, n = [], v, s = d.color, p = d.zIndex, o = d.events, t = {}, w = b.chart.renderer;
    ...
    va.prototype = {
        ...
        defaultLabelFormatter:function() {
            ...
            if (h) g = Ja(h, this); else if (c) g = b; else if (d) g = Oa(d, b); else if (f && a >= 1e3) for (;f-- && g === y; ) c = Math.pow(1e3, f + 1), 
            ...
            o(a.series, function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        ...
                        if (q(d)) if (a.dataMin >= d) a.dataMin = d, a.ignoreMinPadding = !0; else if (a.dataMax < d) a.dataMax = d, 
        ...
        translate:function(a, b, c, d, e, f) {
            ...
            b ? (a = a * h + i, a -= k, a = a / j + d, e && (a = g.lin2val(a))) :(e && (a = g.val2lin(a)), 
            f === "between" && (f = .5), a = h * (a - d) * j + i + h * k + (ra(f) ? j * f * g.pointRange :0));
            return a;
        },
        ...
        getPlotLinePath:function(a, b, c, d, e) {
            ...
            i = j = r(k - e - i);
            isNaN(e) ? m = !0 :this.horiz ? (i = h, j = k - this.bottom, a = c = n(a, g, g + this.width)) :(a = g, 
            c = l - this.right, i = j = n(i, h, h + this.height));
        ...
        setAxisTranslation:function(a) {
            ...
            b.pointRangePadding = g *= h, b.pointRange = C(d, c), k) b.closestPointRange = e;
            if (a) b.oldTransA = j;
        ...
        setTickInterval:function(a) {
            ...
            b.max = p(c.max, c.dataMax), d.type !== b.linkedParent.options.type && la(11, 1)) :(b.min = p(b.userMin, d.min, b.dataMin), 
            b.max = p(b.userMax, d.max, b.dataMax));
            if (e) !a && C(b.min, p(b.dataMin, b.min)) <= 0 && la(10, 1), b.min = ea(Ea(b.min)), 
            b.max = ea(Ea(b.max));
            if (b.range && q(b.max)) b.userMin = b.min = u(b.min, b.max - b.range), b.userMax = b.max, 
            b.range = null;
            ...
            if (!f && !e && !k) b.tickInterval = qb(b.tickInterval, null, pb(b.tickInterval), p(d.allowDecimals, !(b.tickInterval > .5 && b.tickInterval < 5 && b.max > 1e3 && b.max < 9999)), !!this.tickAmount);
        ...
        setTickPositions:function() {
            ...
            this.tickmarkOffset = this.categories && a.tickmarkPlacement === "between" && this.tickInterval === 1 ? .5 :0;
            ...
            if (!this.isLinked) this.trimTicks(b, e, f), this.min === this.max && q(this.min) && !this.tickAmount && (g = !0, 
        ...
        unsquish:function() {
            ...
            c ? (l = q(h) ? [ h ] :f < p(b.autoRotationLimit, 80) && !b.staggerLines && !b.step && b.autoRotation) && o(l, function(a) {
                var b;
                if (a === h || a && a >= -90 && a <= 90) j = m(O(i.h / aa(ha * a))), b = j + O(a / 360), 
                b < k && (k = b, g = a, e = j);
            }) :e = m(i.h);
            this.autoRotation = l;
        ...
        renderUnsquish:function() {
            ...
            if (k.rotation && (l = {
                width:(m > a.chartHeight * .5 ? a.chartHeight * .33 :a.chartHeight) + "px"
        ...
        getOffset:function() {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [ 1, 0, 3, 2 ][h] :h, j, k, l = 0, m, n = 0, v = d.title, s = d.labels, S = 0, N = b.axisOffset, b = b.clipOffset, t = [ -1, 1, 1, -1 ][h], w;
            j = a.hasData();
            ...
            if (v && v.text && v.enabled !== !1) {
                ...
                a.axisTitle.isNew = !0;
                if (k) l = a.axisTitle.getBBox()[g ? "height" :"width"], m = v.offset, n = q(m) ? 0 :p(v.margin, g ? 5 :10);
        ...
        render:function() {
            ...
            if (a.hasData() || f) {
                ...
                if (g.length && (o(g, function(b, c) {
                    if (!f || b >= a.min && b <= a.max) i[b] || (i[b] = new Ta(a, b)), p && i[b].isNew && i[b].render(c, !0, .1), 
                    i[b].render(c);
                }), n && (a.min === 0 || a.single))) i[-1] || (i[-1] = new Ta(a, -1, null, !0)), 
                i[-1].render(-1);
                m && o(g, function(b, c) {
                    if (c % 2 === 0 && b < a.max) k[b] || (k[b] = new A.PlotLineOrBand(a)), t = b + n, 
                    w = g[c + 1] !== y ? g[c + 1] + n :a.max, k[b].options = {
                        from:e ? ia(t) :t,
                        to:e ? ia(w) :w,
                        color:m
        ...
        drawCrosshair:function(a, b) {
            ...
            if (!this.crosshair || (q(b) || !p(this.crosshair.snap, !0)) === !1 || b && b.series && b.series[this.coll] !== this) this.hideCrosshair(); else if (p(d.snap, !0) ? q(b) && (c = this.isXAxis ? b.plotX :this.len - b.plotY) :c = this.horiz ? a.chartX - this.pos :this.len - a.chartY + this.pos, 
            ...
            c === null) this.hideCrosshair(); else if (this.cross) this.cross.attr({
                visibility:"visible"
            })[e ? "animate" :"attr"]({
                d:c
            }, e); else {
    ...
    va.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        if (a >= .5) a = r(a), g = this.getLinearTickPositions(a, b, c); else if (a >= .08) for (var f = V(b), h, i, j, k, l, e = a > .3 ? [ 1, 2, 4 ] :a > .15 ? [ 1, 2, 4, 6, 8 ] :[ 1, 2, 3, 4, 5, 6, 7, 8, 9 ]; f < c + 1 && !l; f++) {
            i = e.length;
            for (h = 0; h < i && !l; h++) j = Ea(ia(f) * e[h]), j > b && (!d || k <= c) && k !== y && g.push(k), 
            k > c && (l = !0), k = j;
        } else if (b = ia(b), c = ia(c), a = e[d ? "minorTickInterval" :"tickInterval"], 
        a = p(a === "auto" ? null :a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 :1)) / ((d ? f / this.tickPositions.length :f) || 1)), 
        a = qb(a, null, pb(a)), g = Ua(this.getLinearTickPositions(a, b, c), Ea), !d) this._minorAutoInterval = a / 5;
    ...
    Nb.prototype = {
        ...
        getPosition:function(a, b, c) {
            var d = this.chart, e = this.distance, f = {}, g = c.h || 0, h, i = [ "y", d.chartHeight, b, c.plotY + d.plotTop ], j = [ "x", d.chartWidth, a, c.plotX + d.plotLeft ], k = p(c.ttBelow, d.inverted && !c.negative || !d.inverted && c.negative), l = function(a, b, c, d) {
                ...
                l.apply(0, i) !== !1 ? m.apply(0, j) === !1 && !h && (n(!0), v()) :h ? f.x = f.y = 0 :(n(!0), 
                v());
            };
        ...
        refresh:function(a, b) {
            ...
            j === !1 ? this.hide() :(this.isHidden && (db(d), d.attr("opacity", 1).show()), 
            d.attr({
                text:j
    ...
    Va.prototype = {
        ...
        normalize:function(a, b) {
            ...
            d.pageX === y ? (c = u(a.x, a.clientX - b.left), d = a.y) :(c = d.pageX - b.left, 
            d = d.pageY - b.top);
            return x(a, {
                chartX:r(c),
                chartY:r(d)
        ...
        runPointActions:function(a) {
            var b = this.chart, c = b.series, d = b.tooltip, e = d ? d.shared :!1, f = b.hoverPoint, g = b.hoverSeries, h, i = b.chartWidth, j, k, l = [], m, n;
            ...
            if (m && (m !== this.prevKDPoint || d && d.isHidden)) {
                ...
                this.prevKDPoint = m;
            } else c = g && g.tooltipOptions.followPointer, d && c && !d.isHidden && (c = d.getAnchor([ {} ], a), 
            d.updatePosition({
                plotX:c[0],
                plotY:c[1]
            }));
    ...
    x(A.Pointer.prototype, {
        ...
        pinchTranslateDirection:function(a, b, c, d, e, f, g, h) {
            ...
            x ? (u -= .8 * (u - g[j][0]), w || (y -= .8 * (y - g[j][1])), c()) :g[j] = [ u, y ];
            o || (f[j] = s - n, f[m] = v);
            f = o ? 1 / p :p;
            e[m] = v;
            e[j] = b;
        ...
        pinch:function(a) {
            ...
            o(c.axes, function(a) {
                ...
                b.hasPinched = h;
                b.scaleGroups(j, l);
                if (!h && b.followTouchMove && f === 1) this.runPointActions(b.normalize(a)); else if (b.res) b.res = !1, 
                this.reset(!1, 0);
            }
        },
        touch:function(a, b) {
            var c = this.chart;
            pa = c.index;
            a.touches.length === 1 ? (a = this.normalize(a), c.isInsidePlot(a.chartX - c.plotLeft, a.chartY - c.plotTop) && !c.openMenu ? (b && this.runPointActions(a), 
    ...
    if (K.PointerEvent || K.MSPointerEvent) {
        var wa = {}, Bb = !!K.PointerEvent, Xb = function() {
            var a, b = [];
            b.item = function(a) {
                return this[a];
            };
    ...
    nb.prototype = {
        init:function(a, b) {
            ...
            this.options = b;
            if (b.enabled) c.itemStyle = d, c.itemHiddenStyle = z(d, b.itemHiddenStyle), c.itemMarginTop = e, 
            ...
            c.render(), H(c.chart, "endResize", function() {
        ...
        renderItem:function(a) {
            ...
            if (!o) {
                ...
                if (!this.baseline) this.fontMetrics = c.fontMetrics(h.fontSize, o), this.baseline = this.fontMetrics.f + 3 + v, 
            ...
            this.itemY += v + this.lastLineHeight + n, this.lastLineHeight = 0;
    ...
    Na = A.LegendSymbolMixin = {
        ...
        drawLineMarker:function(a) {
            ...
            d = a.symbolWidth;
            var e = this.chart.renderer, f = this.legendGroup, a = a.baseline - r(a.fontMetrics.b * .3), g;
            if (b.lineWidth) {
                g = {
    ...
    F.prototype = {
        ...
        renderLabels:function() {
            ...
            b.items && o(b.items, function(c) {
                var d = x(b.style, c.style), e = D(d.left) + a.plotLeft, f = D(d.top) + a.plotTop + 12;
                delete d.left;
                delete d.top;
    ...
    var Yb = A.CenteredSeriesMixin = {
        getCenter:function() {
            var a = this.options, b = this.chart, c = 2 * (a.slicedOffset || 0), d = b.plotWidth - 2 * c, b = b.plotHeight - 2 * c, e = a.center, e = [ p(e[0], "50%"), p(e[1], "50%"), a.size || "100%", a.innerSize || 0 ], f = C(d, b), g, h;
    ...
    R.prototype = {
        ...
        autoIncrement:function() {
            ...
            if (d === "month" || d === "year") a = new Aa(b), a = d === "month" ? +a[wb](a[Ya]() + c) :+a[xb](a[Za]() + c), 
            c = a - b;
            this.xIncrement = b + c;
            return b;
        },
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) o(a, function(a, b) {
                ...
                if (n && h > n) {
                    ...
                    if (ra(k)) {
                        ...
                        e.xIncrement = m;
                    } else if (Ha(k)) if (q) for (c = 0; c < h; c++) i = a[c], v[c] = i[0], s[c] = i.slice(1, q + 1); else for (c = 0; c < h; c++) i = a[c], 
                    v[c] = i[0], s[c] = i[1]; else la(12);
        ...
        processData:function(a) {
            ...
            c = []; else if (b[0] < l || b[d - 1] > m) e = this.cropData(this.xData, this.yData, l, m), 
        ...
        generatePoints:function() {
            ...
            for (m = 0; m < g; m++) i = h + m, j ? l[m] = new f().init(this, [ d[m] ].concat(sa(e[m]))) :(b[i] ? k = b[i] :a[i] !== y && (b[i] = k = new f().init(this, a[i], d[m])), 
            l[m] = k), l[m].index = i;
            if (b && (g !== (c = b.length) || j)) for (m = 0; m < c; m++) if (m === h && !j && (m += g), 
            b[m]) b[m].destroyElements(), b[m].plotX = y;
            this.data = b;
            this.points = l;
        },
        getExtremes:function(a) {
            ...
            d = a.length;
            for (l = 0; l < d; l++) if (j = c[l], k = a[l], i = k !== null && k !== y && (!b.isLog || k.length || k > 0), 
        ...
        translate:function() {
            ...
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === "between" || ra(i), k = a.threshold, l = a.startFromThreshold ? k :0, m, n, v, o = Number.MAX_VALUE, a = 0; a < g; a++) {
                ...
                if (b && this.visible && w && w[x]) w = w[x], t = w.points[this.index + "," + a], 
                n = t[0], t = t[1], n === l && (n = p(k, e.min)), e.isLog && n <= 0 && (n = null), 
                r.total = r.stackTotal = w.total, r.percentage = w.total && r.y / w.total * 100, 
                r.stackY = t, w.setOffset(this.pointXOffset || 0, this.barW || 0);
        ...
        setClip:function(a) {
            ...
            a && (h.count += 1);
            if (this.options.clip !== !1) this.group.clip(a || e ? h :b.clipRect), this.markerGroup.clip(i), 
        ...
        drawPoints:function() {
            ...
            d = V(g.plotX), e = g.plotY, k = g.graphic, n = g.marker || {}, v = !!g.marker, 
            a = q && n.enabled === y || n.enabled, o = g.isInside, a && e !== y && !isNaN(e) && g.y !== null) if (a = g.pointAttr[g.selected ? "select" :""] || m, 
            h = a.r, i = p(n.symbol, this.symbol), j = i.indexOf("url") === 0, k) k[o ? "show" :"hide"](!0).animate(x({
                x:d - h,
                y:e - h
            }, k.symbolName ? {
                width:2 * h,
        ...
        destroy:function() {
            ...
            for (g in a) a[g] instanceof Q && !a[g].survive && (d = c && g === "group" ? "hide" :"destroy", 
            a[g][d]());
        ...
        applyZones:function() {
            ...
            if (d.length && (i || j)) i && i.hide(), j && j.hide(), m = l.getExtremes(), o(d, function(d, o) {
                ...
                g[o] ? g[o].animate(h) :(g[o] = c.clipRect(h), i && a["zoneGraph" + o].clip(g[o]), 
    ...
    Ib.prototype = {
        ...
        setOffset:function(a, b) {
            var c = this.axis, d = c.chart, e = d.inverted, f = c.reversed, f = this.isNegative && !f || !this.isNegative && f, g = c.translate(c.usePercentage ? 100 :this.total, 0, 0, 0, 1), c = c.translate(0), c = O(g - c), h = d.xAxis[0].translate(this.x) + a, i = d.plotHeight, f = {
                x:e ? f ? g :g - c :h,
    ...
    R.prototype.setStackedPoints = function() {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            var a = this.processedXData, b = this.processedYData, c = [], d = b.length, e = this.options, f = e.threshold, g = e.startFromThreshold ? f :0, h = e.stack, e = e.stacking, i = this.stackKey, j = "-" + i, k = this.negStacks, l = this.yAxis, m = l.stacks, n = l.oldStacks, o, s, q, r, t, w;
            for (r = 0; r < d; r++) {
                t = a[r];
                w = b[r];
                q = this.index + "," + r;
    ...
    x(R.prototype, {
        addPoint:function(a, b, c, d) {
            ...
            c && (g[0] && g[0].remove ? g[0].remove(!1) :(g.shift(), e.updateParallelArrays(i, "shift"), 
            h.shift()));
            e.isDirty = !0;
            e.isDirtyData = !0;
    ...
    xa = ka(R, {
        ...
        translate:function() {
            var a = this, b = a.chart, c = a.options, d = a.borderWidth = p(c.borderWidth, a.closestPointRange * a.xAxis.transA < 2 ? 0 :1), e = a.yAxis, f = a.translatedThreshold = e.getThreshold(c.threshold), g = p(c.minPointLength, 5), h = a.getColumnMetrics(), i = h.width, j = a.barW = u(i, 1 + 2 * d), k = a.pointXOffset = h.offset, l = -(d % 2 ? .5 :0), m = d % 2 ? .5 :1;
            b.inverted && (f -= .5, b.renderer.isVML && (m += 1));
            ...
            o(a.points, function(c) {
                ...
                w = u(h, d) - t;
                O(w) < g && g && (w = g, x = !e.reversed && !c.negative || e.reversed && c.negative, 
                t = r(O(t - f) > g ? d - g :f - (x ? g :0)));
                c.barX = o;
                c.pointWidth = i;
                q = r(o + q) + l;
                o = r(o) + l;
        ...
        drawPoints:function() {
            ...
            o(a.points, function(h) {
                ...
                if (i !== y && !isNaN(i) && h.y !== null) f = h.shapeArgs, i = q(a.borderWidth) ? {
                    "stroke-width":a.borderWidth
                } :{}, g = h.pointAttr[h.selected ? "select" :""] || a.pointAttr[""], j ? (db(j), 
                j.attr(i)[b.pointCount < e ? "animate" :"attr"](z(f))) :h.graphic = d[h.shapeType](f).attr(i).attr(g).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius); else if (j) h.graphic = j.destroy();
            });
        },
        animate:function(a) {
            var b = this.yAxis, c = this.options, d = this.chart.inverted, e = {};
            if (ca) a ? (e.scaleY = .001, a = C(b.pos + b.len, u(b.pos, b.toPixels(c.threshold))), 
    ...
    U = {
        ...
        updateTotals:function() {
            ...
            this.total = b;
            for (a = 0; a < d; a++) e = c[a], e.percentage = b > 0 && (e.visible || !f) ? e.y / b * 100 :0, 
            e.total = b;
        },
        generatePoints:function() {
        ...
        translate:function(a) {
            this.generatePoints();
            var b = 0, c = this.options, d = c.slicedOffset, e = d + c.borderWidth, f, g, h, i = c.startAngle || 0, j = this.startAngleRad = ma / 180 * (i - 90), i = (this.endAngleRad = ma / 180 * (p(c.endAngle, i + 360) - 90)) - j, k = this.points, l = c.dataLabels.distance, c = c.ignoreHiddenPoint, m, n = k.length, o;
    ...
    R.prototype.alignDataLabel = function(a, b, c, d, e) {
        var f = this.chart, g = f.inverted, h = p(a.plotX, -999), i = p(a.plotY, -999), j = b.getBBox(), k = f.renderer.fontMetrics(c.style.fontSize).b, l = this.visible && (a.series.forceDL || f.isInsidePlot(h, r(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 :d.y + d.height - 1, g));
        if (l) d = x({
            x:g ? f.plotWidth - i :h,
            ...
            align:c.align
        })) :(b.align(c, null, d), g = b.alignAttr, p(c.overflow, "justify") === "justify" ? this.justifyDataLabel(b, c, g, j, d, e) :p(c.crop, !0) && (l = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + j.width, g.y + j.height)), 
        c.shape && b.attr({
            anchorX:a.plotX,
            anchorY:a.plotY
        }));
    ...
    if (M.pie) M.pie.prototype.drawDataLabels = function() {
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                if (K) {
                    ...
                    if (m > 0) {
                        ...
                        for (G = 0; G < K; G++) {
                            ...
                            if (J < G && I[G] !== null) J = G; else for (t < K - G + J && I[G] !== null && (J = t - K + G); I[J] === null; ) J++;
                            M.push({
                                i:J,
                                y:I[J]
                            });
                    ...
                    for (G = 0; G < K; G++) {
                        ...
                        y.connX = B;
                        y.connY = A;
                        if (this.options.size === null) t = y.width, B - t < f ? E[3] = u(r(t - B + f), E[3]) :B + t > h - f && (E[1] = u(r(B + t - h + f), E[1])), 
            ...
            if (Fa(E) === 0 || this.verifyDataLabelOverflow(E)) this.placeDataLabels(), x && g && o(this.points, function(b) {
                j = b.connector;
                w = b.labelPos;
                if ((y = b.dataLabel) && y._pos && b.visible) D = y._attr.visibility, B = y.connX, 
                A = y.connY, k = l ? [ "M", B + (w[6] === "left" ? 5 :-5), A, "C", B, A, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], "L", w[4], w[5] ] :[ "M", B + (w[6] === "left" ? 5 :-5), A, "L", w[2], w[3], "L", w[4], w[5] ], 
                j ? (j.animate({
                    d:k
        ...
        o(this.points, function(a) {
            var b = a.dataLabel;
            if (b && a.visible) (a = b._pos) ? (b.attr(b._attr), b[b.moved ? "animate" :"attr"](a), 
            b.moved = !0) :b && b.attr({
                y:-999
            });
        });
        ...
        d[1] !== null ? f = u(C(f, b[2] - u(a[0], a[2])), e) :(f = u(C(f, b[2] - a[0] - a[2]), e), 
        b[1] += (a[0] - a[2]) / 2);
        f < b[2] ? (b[2] = f, b[3] = /%$/.test(c.innerSize || 0) ? f * parseFloat(c.innerSize || 0) / 100 :parseFloat(c.innerSize || 0), 
        this.translate(b), o(this.points, function(a) {
    ...
    U = A.TrackerMixin = {
        ...
        drawTrackerGraph:function() {
            ...
            }, p = "rgba(192,192,192," + (ca ? 1e-4 :.002) + ")";
    ...
    x(Ga.prototype, {
        ...
        onMouseOver:function(a) {
            ...
            if (this.series) this.firePointEvent("mouseOver"), d && (!d.shared || b.noSharedTooltip) && d.refresh(this, a), 
    ...
    x(R.prototype, {
        ...
        setState:function(a) {
            ...
            if (this.state !== a && (this.state = a, !(d[a] && d[a].enabled === !1) && (a && (e = d[a].lineWidth || e + (d[a].lineWidthPlus || 0)), 
            c && !c.dashstyle))) {
                a = {
                    "stroke-width":e
                };
