...
//	});
	  ...
	  var li=document.getElementsByClassName('selectChange')[1];
	  var month=li.getElementsByTagName('option');
	  for(var i=0;i<month.length;i++){
	  	month[i].onclick=function(){
	  		var val=parseInt(this.value);
	  		val=val+1;
	  		document.getElementsByClassName('fllow')[0].innerHTML=val;
	  	}
	  }
	  add();
	  reduce();
	  ...
	  function add(){
	    ...
	    monthNext.onclick=function(){
	    	var count=document.getElementsByClassName('fllow')[0].innerHTML;
	    	if(count<12){
	    		count++;
	    	}
	    	else{
	    	...
	    	document.getElementsByClassName('fllow')[0].innerHTML=count;	
	    }
	  }
	  function reduce(){
