	...
	public function avatar_data() {
		...
		switch($_GET['action']){
			...
			case 'uploadavatar':
				...
				@file_put_contents($dir.'original.jpg', $pic1);
				@file_put_contents($dir.'large.jpg', $pic1);
				@file_put_contents($dir.'moderate.jpg',$pic2);
				@file_put_contents($dir.'small.jpg', $pic3);
