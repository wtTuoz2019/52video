...
$config['URL_HTML_MODEL']='1'; //伪静态样式

//模板设置
$config['TPL_TEMPLATE_PATH']='themes/html/';//模板目录，一般不需要修改
...
$config['MOBILE_DOMAIN']='wap.shanyueyun.com';
