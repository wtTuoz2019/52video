...
class commonMod
{
    ...
    public function __construct(){
		...
		if($admininfo){
			...
			/*$_SESSION['csid']=$admininfo['cid'];*/
			if($admininfo['logo']) $this->config['logo']=$admininfo['logo'];
			...
			}elseif($siteurl!='school.52video.net'&&$siteurl!='wap.52video.net'){*/
				
		//	$this->redirect('http://www.52video.net');die;
				}
